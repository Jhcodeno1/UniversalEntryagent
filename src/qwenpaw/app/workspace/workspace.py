...
- ChatManager (chat/session metadata)
...
class Workspace:
    ...
    - ChatManager: Manages chat/session metadata

    This standalone runtime intentionally excludes channel and cron services,
    because the intent router project only needs local ask/chat execution
    and must not expose heartbeat behavior.
    """
